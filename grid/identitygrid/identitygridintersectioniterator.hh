...
namespace Dune {
  ...
  public:
    ...
    typedef Dune::Intersection<const GridImp, Dune::IdentityGridLeafIntersectionIterator> Intersection;
  ...
  public:
    ...
    typedef typename GridImp::template Codim<1>::LocalGeometry LocalGeometry;
    typedef typename GridImp::template Codim<0>::Entity Entity;
    typedef Dune::Intersection<const GridImp, Dune::IdentityGridLevelIntersectionIterator> Intersection;
